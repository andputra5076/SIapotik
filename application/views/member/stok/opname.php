                    ...
                    <header class="panel-heading">
                        <div class="row show-grid">
                            ...
                            <div class="col-md-6" align="right">
                                <?php
                                echo level_user('stok', 'opname', $this->session->userdata('kategori'), 'add') > 0 ? '
                                <div style=" grid-template-columns: 1fr 1fr; column-gap: 10px;">
                                    <a class="btn btn-primary" href="#"  data-toggle="modal" data-target="#verifikasiData"><i class="fa fa-search"></i> Verifikasi Stok Opname</a>
